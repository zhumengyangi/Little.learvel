                ...
                <div class="table-responsive">
                    <table class="table mb30">
                        ...
                        <tr v-for="bonus in bonus_list">
                            ...
                            <td>
                                <button class="btn btn-warning" v-if="bonus.left_nums <= 0">红包已经抢完</button>
                ...
                <div class="table-responsive">
                    <table class="table mb30">
                        ...
                        <tr v-for="bonus in bonus_record">
                            ...
                            <td>{ bonus.money }</td>
                            <td>
                                <button class="btn btn-warning" v-if="bonus.flag == 2">最佳手气哦</button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            methods: {
                ...
                getBonus: function(bonus_id){
                    ...
                    $.ajax({
                        url: '/study/get/bonus',
                        type: "get",
                        data: {bonus_id: bonus_id, user_id:1},//    user_id 可变
                        dataType: "json",
                        success: function (res) {
                            if(res.code == 2000){
                                that.getList();
